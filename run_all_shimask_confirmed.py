...
# The reviewed annotation filenames were simplified for display and do not always
# exactly match the original scan stem.  This is a fixed, auditable mapping for
# those reviewed sheets only; no fuzzy image matching is performed.
